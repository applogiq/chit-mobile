      ...
      <View
        ...
        >
          <Image
            ...
            style={{ height: 25, width: 25, marginTop: "-4%", marginLeft: "20%", borderRadius: 10 }}></Image>
          ...
          <View style={styles.modalView}>
            <View style={{}}>
              <Pressable onPress={() => {
                ...
                <Text style={{ marginLeft: width * (70 / 100), marginBottom: height * (2 / 100), fontWeight: "700", fontSize: 20, color: "black" }}>X</Text>
              </Pressable>
              <Text style={styles.modalText}>Choose an action to upload a picture</Text>
