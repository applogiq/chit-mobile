...
marginTop:10,marginBottom:5
    ...
    title:{color:"rgba(65, 39, 15, 0.8)",fontWeight:"700",fontFamily:"SourceSansPro-SemiBold",lineHeight:21,marginBottom:5},
    input:{backgroundColor:"white",width:'100%',borderRadius:6},
    eyeicon:{height:15,width:22},
    errormessage:{color:"red",fontFamily:"SourceSansPro-Light",fontWeight:"600",textTransform:"capitalize"}
})
